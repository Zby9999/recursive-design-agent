...
加入第一个 seed-extraction workbench 路径。设计师可以提供 Figma seed reference，mocked AgentAdapter 返回 seed evidence package，包括视觉表面、evidence anchors 和 annotations，Browser UI 将它们渲染到 tldraw-powered canvas 上。
