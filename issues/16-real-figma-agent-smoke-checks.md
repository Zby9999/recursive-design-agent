...
- [ ] 使用已配置的 external agent environment 提供 Figma MCP access；Local Bridge 不实现 Figma MCP。
- [ ] 至少一个真实 headless CLI adapter path 通过 Bridge task lifecycle 被 smoke-tested。
